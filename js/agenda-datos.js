...
const EVENTOS = [
    ...
    {fecha:'2026-09-24',titulo:'«Jueves de Palabra» 3 — El Evangelio',hora:'7:00 PM',desc:'Formación bíblica con el Párroco (7:00 p.m.), dedicada al Evangelio.',resp:'Párroco',cat:CAT.FORMACION},
    {fecha:'2026-09-26',titulo:'Los seminaristas llegan a la parroquia',hora:'9:00 AM',desc:'Un grupo de seminaristas del Seminario Mayor Santo Tomás de Aquino, que hará su apostolado en la parroquia durante el año escolar, acompaña el encuentro de la Palabra y el curso de liturgia (9:00 a.m.).',resp:'Seminaristas + Proyecto Palabra',cat:CAT.FORMACION},
    ...
    // OCTUBRE
    {fecha:'2026-10-01',titulo:'Santa Teresita del Niño Jesús — «Jueves de Palabra»',hora:'6:00 PM',desc:'Santa Misa (6:00 p.m.), con su imagen en lugar destacado y flores, y charla sobre su espiritualidad (7:00 p.m.), a cargo del Párroco o de un sacerdote invitado.',resp:'Párroco',cat:CAT.SOLEMNE},
    ...
    {fecha:'2026-10-02',titulo:'Celebración de la Palabra en la Zona de la Natividad',hora:'7:00 PM',desc:'El Párroco celebra la Palabra con la comunidad de la Zona de la Natividad (calle Nueva Venecia).',resp:'Proyecto Palabra + Legión de María',cat:CAT.MISION},
    {fecha:'2026-10-03',titulo:'Venta de almuerzo pro «María Móvil»',hora:'',desc:'Para construir sobre una camioneta una estructura que proteja la réplica de Santa Lucía en sus traslados.',resp:'Sociedades de damas + Servidores de Santa Lucía',cat:CAT.NORMAL},
    {fecha:'2026-10-03',titulo:'Comienza la Hora Santa de los sábados',hora:'7:00 PM',desc:'Desde hoy, segunda Hora Santa parroquial cada sábado a las 7:00 p.m., en preparación al domingo. Los seminaristas comienzan también el visiteo casa por casa en los sectores con comunidad de la Palabra.',resp:'Coros Parroquiales',cat:CAT.NORMAL},
    {fecha:'2026-10-04',titulo:'San Francisco de Asís — VIII centenario de su muerte',hora:'',desc:'Eucaristías dominicales, con memoria de los ochocientos años de su tránsito.',resp:'',cat:CAT.NORMAL},
    ...
    {fecha:'2026-10-08',titulo:'«Jueves de Palabra» 4 — Lectio divina',hora:'7:00 PM',desc:'Cierre del ciclo de formación bíblica con la lectio divina (7:00 p.m.).',resp:'Párroco',cat:CAT.FORMACION},
    {fecha:'2026-10-10',titulo:'Reparto de Alimentos',hora:'',desc:'Jornada de reparto para los más necesitados, con el apoyo de los asesores y coordinadores de la Hermandad de Samuel.',resp:'Cáritas Parroquial + El Llamado de Samuel',cat:CAT.MISION},
    ...
    {fecha:'2026-10-24',titulo:'Gran Misión Parroquial',hora:'Desde la mañana',desc:'Visiteo por los sectores para invitar a las comunidades de la Palabra. Los detalles se darán a conocer más adelante.',resp:'Todos los grupos',cat:CAT.MISION,imagen:'foto-mision.webp'},
    {fecha:'2026-10-31',titulo:'Fiesta de Holywins',hora:'6:00 PM',desc:'Santa Misa (6:00 p.m.) y fiesta para los niños.',resp:'Ministerio de Catequesis',cat:CAT.NORMAL},
    // NOVIEMBRE
    ...
    {fecha:'2026-11-12',titulo:'Anuncio de las Fiestas Patronales',hora:'',desc:'Entrega de pasquines por las calles de la parroquia. Lema: «150 años fieles a la tradición, abiertos a la misión».',resp:'Todos los grupos',cat:CAT.PATRONAL},
    {fecha:'2026-11-13',titulo:'Juramentación — Servidores y Sociedad de Santa Lucía',hora:'5:30 PM',desc:'Rosario (5:30 p.m.) y Santa Misa (6:00 p.m.). La bendición, dentro de la Eucaristía, será el día en que pueda venir el Obispo.',resp:'Servidores de Santa Lucía + Sociedad de Santa Lucía',cat:CAT.PATRONAL},
    {fecha:'2026-11-14',titulo:'BAJADA DE SANTA LUCÍA',hora:'Mañana y tarde',desc:'Eucaristía por la mañana y, por la tarde, bajada de la imagen con homenaje gaitero. Recorrido: Natividad, Federación, Dos Rosas, Nueva Venecia, Belén, Santa Lucía, Nueva Belloso, Casanova, Natividad y templo.',resp:'Servidores de Santa Lucía',cat:CAT.PATRONAL,imagen:'foto-bajada-santa-lucia.webp'},
    {fecha:'2026-11-18',titulo:'Solemnidad de Ntra. Sra. de Chiquinquirá (La Chinita)',hora:'9:00 AM',desc:'Misa parroquial (9:00 a.m.) y, a continuación, traslado de la parroquia a la Basílica.',resp:'Servidores del Altar',cat:CAT.SOLEMNE,imagen:'foto-chinita.webp'},
    {fecha:'2026-11-20',titulo:'Cuarenta Horas — Solemnidad de Cristo Rey',hora:'',desc:'Del viernes 20 al domingo 22 de noviembre: adoración al Santísimo en la jornada del apostolado seglar, con la oración y los ministerios propios de los laicos. Los turnos de madrugada los cubren solo adultos.',resp:'Todos los grupos',cat:CAT.SOLEMNE},
    {fecha:'2026-11-22',titulo:'CRISTO REY — Clausura de las Cuarenta Horas',hora:'6:00 PM',desc:'Eucaristías dominicales y clausura de las Cuarenta Horas. Santa Cecilia: encuentro con los coros parroquiales después de la Misa de 6:00 p.m.',resp:'Coros Parroquiales',cat:CAT.SOLEMNE},
    {fecha:'2026-11-22',titulo:'La réplica de Santa Lucía peregrina a La Guajira',hora:'9:00 AM',desc:'Recibimiento en Guarero (9:00 a.m.) y en Paraguaipoa (5:00 p.m.), con Eucaristía. Regreso esa misma noche.',resp:'Servidores de Santa Lucía',cat:CAT.PATRONAL},
    {fecha:'2026-11-27',titulo:'La réplica de Santa Lucía en la Parroquia Cristo Rey',hora:'6:00 PM',desc:'Recibimiento en la Parroquia Cristo Rey, Curva de Molina (6:00 p.m.).',resp:'Servidores de Santa Lucía',cat:CAT.PATRONAL},
    {fecha:'2026-11-28',titulo:'La réplica de Santa Lucía en Potrerito y El Carmelo',hora:'',desc:'Visita a Potrerito, filial de El Carmelo, por la mañana, y Eucaristía en El Carmelo por la tarde.',resp:'Servidores de Santa Lucía',cat:CAT.PATRONAL},
    {fecha:'2026-11-28',titulo:'Encuentro de Santa Lucía y La Chinita',hora:'8:00 PM',desc:'La réplica de Santa Lucía sale al encuentro de la procesión patronal de La Chinita (8:00 p.m.). La imagen original no sale, por ser patrimonio.',resp:'Servidores de Santa Lucía + Flores de Misericordia',cat:CAT.PATRONAL,imagen:'foto-bajada-santa-lucia.webp'},
    ...
    {fecha:'2026-11-29',titulo:'La réplica de Santa Lucía en San Benito del Bajo',hora:'',desc:'Visita a San Benito del Bajo y al Santísimo Cristo de San Francisco, por confirmar por esas parroquias.',resp:'Servidores de Santa Lucía',cat:CAT.PATRONAL},
    // DICIEMBRE
    ...
    {fecha:'2026-12-05',titulo:'La réplica de Santa Lucía peregrina a El Moján',hora:'',desc:'Salida el sábado por la mañana. El domingo 6 la reciben con la Eucaristía (6:00 p.m.) y se regresa después. La novena en el templo sigue con normalidad.',resp:'Servidores de Santa Lucía',cat:CAT.PATRONAL},
    {fecha:'2026-12-08',titulo:'Inmaculada Concepción — Cumpleaños del Párroco',hora:'5:30 PM',desc:'Novena (5:30 p.m.), Eucaristía (6:00 p.m.) y tortazo comunitario por el cumpleaños del Párroco.',resp:'Sociedades parroquiales + Servidores del Altar',cat:CAT.SOLEMNE},
    {fecha:'2026-12-11',titulo:'La réplica de Santa Lucía en Ntra. Sra. de Guadalupe',hora:'5:00 PM',desc:'La Iglesia Nuestra Señora de Guadalupe recibe la réplica (5:00 p.m.), en vísperas de su fiesta.',resp:'Servidores de Santa Lucía',cat:CAT.PATRONAL},
    ...
    {fecha:'2026-12-13',titulo:'SOLEMNIDAD DE SANTA LUCÍA',hora:'Todo el día',desc:'Eucaristías solemnes y procesión, con un recorrido más largo: Múcura, Candelaria, Plaza de la Muñeca, San Ramón, Nueva Belloso, San Luis, Belén, San Pablo, El Rosal, El Valle, Santa Lucía, Triana, San Antonio, Santa Genoveva y Nueva Belloso, para entrar por Santa Lucía hasta el templo.',resp:'Todos los grupos',cat:CAT.PATRONAL,imagen:'foto-santa-lucia.webp'},
    {fecha:'2026-12-14',titulo:'Ofrenda de los Chimbángueles',hora:'',desc:'Ofrenda de los chimbángueles a Santa Lucía.',resp:'',cat:CAT.PATRONAL},
...
const DESTACADOS = [
    ...
    },
    {
        ...
        desc:'¡Salimos a los sectores! Visitaremos casa por casa para invitar a los vecinos a las comunidades de la Palabra.',
        items:['3 Oct — Comienza la Hora Santa de los sábados, 7:00 PM','8 Oct — «Jueves de Palabra»: lectio divina, 7:00 PM','10 Oct — Reparto de alimentos de Cáritas','24 Oct — Gran Misión: visiteo por los sectores'],
        imagen:'foto-mision.webp', btn:null
    },
    {
        desde:'2026-10-25', hasta:'2026-11-15',
        titulo:'Bajada de Santa Lucía',
        kicker:'14 de Noviembre · Fiestas Patronales',
        hora:'Eucaristía por la mañana · Bajada por la tarde',
        desc:'«150 años fieles a la tradición, abiertos a la misión». Comienzan las fiestas: nuestra Patrona baja de su altar y recorre las calles del sector con homenaje gaitero.',
        items:['12 Nov — Anuncio de las fiestas: entrega de pasquines','13 Nov — Juramentación de los Servidores y de la Sociedad de Santa Lucía, 5:30 PM','14 Nov — Eucaristía por la mañana y bajada por la tarde'],
        imagen:'foto-bajada-santa-lucia.webp',
        btn:{texto:'Ver el recorrido de la Bajada', href:'recorrido-bajada-2026.webp', icono:'fa-map-location-dot'}
    },
    {
        desde:'2026-11-15', hasta:'2026-11-29',
        titulo:'Cuarenta Horas en la Solemnidad de Cristo Rey',
        kicker:'20 – 22 de Noviembre · Jornada del apostolado seglar',
        hora:'Adoración al Santísimo',
        desc:'Tres días ante el Señor Sacramentado, con la oración y los ministerios propios de los laicos. Mientras tanto, la réplica de Santa Lucía peregrina por parroquias lejanas.',
        items:['18 Nov — La Chinita: Misa parroquial, 9:00 AM, y traslado a la Basílica','20 – 22 Nov — Cuarenta Horas','22 Nov — La réplica en Guarero y Paraguaipoa','27 Nov — La réplica en la Parroquia Cristo Rey, 6:00 PM','28 Nov — Encuentro con la procesión de La Chinita, 8:00 PM'],
        imagen:'foto-corpus-christi.webp', btn:null
    },
    {
        ...
        desc:'¡El día más grande de nuestra parroquia! Eucaristías solemnes y la procesión más larga de los últimos años. «150 años fieles a la tradición, abiertos a la misión».',
        items:['4 – 12 Dic — Novena: rezo (5:30 PM) y Eucaristía (6:00 PM)','8 Dic — Inmaculada Concepción y cumpleaños del Párroco','12 Dic — Último día de novena y mañanitas, 11:00 PM','13 Dic — Eucaristías solemnes y procesión','14 Dic — Ofrenda de los chimbángueles'],
        imagen:'foto-santa-lucia.webp',
        btn:{texto:'Ver el recorrido de la procesión', href:'recorrido-procesion-2026.webp', icono:'fa-map-location-dot'}
    },
    {
        ...
        items:['15 – 23 Dic — Misas de Aguinaldo, 6:00 AM','24 Dic — Misa de Gallo, 7:00 PM','25 Dic — Misa de Navidad, 6:00 PM','27 Dic — Sagrada Familia: bendición para las familias','1 Ene — Año Nuevo: Misa, 6:00 PM'],
